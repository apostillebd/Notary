...
export default function WhatsAppButton() {
  // এখানে আপনার বাংলাদেশের হোয়াটসঅ্যাপ নাম্বারটি দিন (country code সহ)
  const phoneNumber = "8801XXXXXXXXX"; 
  // ইউজার বাটনটিতে ক্লিক করলে ডিফল্টভাবে যে মেসেজটি টাইপ করা থাকবে
  const message = "Hello, I would like to know more about your notary services.";
